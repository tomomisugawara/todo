window.addEventListener('DOMContentLoaded', function () {
  ...
  $('.label').on('click', function () {
    ...
    var $messages = ['おつかれさまにゃ！', 'タスク達成おめでとうにゃ！', '素晴らしいのにゃ！','生きてるだけでほめられたいのにゃ。','コアラのマーチより、パックンチョの方が先輩にゃ。','天才なにゃの？','毎日寝て過ごしたいにゃ、もう何もする気が起きないにゃ、来世はダニになりたいにゃ。','明日死ぬかの様に生きよ。永遠に生きるかの様に学べ。マハトマ・ガンジーの名言にゃ。','リンカーンは「たいていの人は、決意した程度だけ幸福になれる」と言ったそうにゃ。'];
